...
let
  ...
  generated = self: {
    ...
    "push" = python.mkDerivation {
      name = "push-0.0.1";
      src = pkgs.fetchurl { url = "https://github.com/garbas/push/archive/master.tar.gz"; sha256 = "7fa5cce8617c59e96234a8ad78ea475b647342f294505b286ea41966a3cb642a"; };
  ...
  overrides = import ./push_override.nix { inherit pkgs python; };
