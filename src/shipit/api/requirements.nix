...
let
  ...
  generated = self: {
    ...
    "Werkzeug" = python.mkDerivation {
      name = "Werkzeug-0.15.0";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/fc/50/b533e424151fbcf9ed3f1853fe564b402072cd949e2f3e1e7aedd12707cf/Werkzeug-0.15.0.tar.gz";
