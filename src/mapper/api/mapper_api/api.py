...
@backend_common.auth.auth.require_permissions([mapper_api.config.SCOPE_PREFIX + '/project/insert'])
...
@backend_common.auth.auth.require_permissions([mapper_api.config.SCOPE_PREFIX + '/mapping/insert'])
