...
let
  sources = {
    ...
    "caniuse-db-1.0.30000634" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-db/-/caniuse-db-1.0.30000634.tgz";
        sha1 = "439f4b95e715b1fd105196d40c681edd7122e622";
      };
    };
    ...
    "electron-to-chromium-1.2.6" = {
      ...
      version = "1.2.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.2.6.tgz";
        sha1 = "f38ad51d1919b06bc07275c62629db803ddca05a";
      };
    };
    "function-bind-1.1.0" = {
      name = "function-bind";
    ...
    "uglify-js-2.8.10" = {
      ...
      version = "2.8.10";
      src = fetchurl {
        url = "https://registry.npmjs.org/uglify-js/-/uglify-js-2.8.10.tgz";
        sha1 = "bd0be568369f7be8cad2a4161fa90ada118ef73a";
      };
    };
    "no-case-2.3.1" = {
      name = "no-case";
...
in
{
  ...
  "css-loader-^0.26.2" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      ...
      sources."caniuse-db-1.0.30000634"
      sources."normalize-range-0.1.2"
      sources."num2fraction-1.2.2"
      sources."electron-to-chromium-1.2.6"
  ...
  "webpack-merge-^4.0.0" = nodeEnv.buildNodePackage {
    ...
    version = "4.0.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/webpack-merge/-/webpack-merge-4.0.0.tgz";
      sha1 = "4347ebeb9e71aaa413baef66be74d4eb2656b66a";
    };
    dependencies = [
      sources."lodash-4.17.4"
    ];
