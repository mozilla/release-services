...
Every push to ``mozilla/release-services`` is tested via Taskcluster_.

Integration with Github
-----------------------

Taskcluster supports `integration with Github`_ by defining tasks to run via
``.taskcluster.yml`` file. ``.taskcluster.yml`` of ``mozilla/release-services``
...
Apart from building, testing and deploying services ``mozilla/release-services``
