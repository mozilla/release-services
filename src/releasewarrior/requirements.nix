...
let
  ...
  generated = self: {
    ...
    "GitPython" = python.mkDerivation {
      name = "GitPython-2.1.7";
      src = pkgs.fetchurl { url = "https://pypi.python.org/packages/e1/ec/9f2bbc86a0188bf83221212be87fa4b70dc71a9385efcc95a25e9789894e/GitPython-2.1.7.tar.gz"; sha256 = "13c7cd99c2bf277fc99accfc25148752fa90e7cc6c6d08a3f01d229dacb461d9"; };
    ...
    "gitdb2" = python.mkDerivation {
      name = "gitdb2-2.0.3";
      src = pkgs.fetchurl { url = "https://pypi.python.org/packages/84/11/22e68bd46fd545b17d0a0b200cf75c20e9e7b817726a69ad5f3070fd0d3c/gitdb2-2.0.3.tar.gz"; sha256 = "b60e29d4533e5e25bb50b7678bbc187c8f6bcff1344b4f293b2ba55c85795f09"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."smmap2"
