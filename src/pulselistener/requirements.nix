...
#
# COMMAND:
#   pypi2nix -v -C /app/src/pulselistener/../../../tmp/pypi2nix -V 3.7 -O ../../nix/requirements_override.nix -E libffi -E openssl -E pkgconfig -E freetype.dev -s intreehooks -s flit -s pytest-runner -s setuptools-scm -r requirements.txt -r requirements-dev.txt
#
...
let
  ...
  generated = self: {
    ...
    "libmozdata" = python.mkDerivation {
      ...
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/85/b1/9d399ba49e6d1f6f9cd2c7bdbce8114d7269916aeadef631af0ea2707813/libmozdata-0.1.57.tar.gz";
        sha256 = "0b543d805d973cf4d073085580b3dc710956f73b46e49ee9590dc9ab06a1c3c4";
      };
      doCheck = commonDoCheck;
      checkPhase = "";
      installCheckPhase = "";
