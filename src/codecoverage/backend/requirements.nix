...
#
# COMMAND:
#   pypi2nix -v -C /app/src/codecoverage/backend/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -e vcversioner -e pytest-runner -e setuptools-scm -r requirements.txt -r requirements-dev.txt
#
