...
#
# COMMAND:
#   pypi2nix -v -C /app/src/bugbug/data/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -E blas -E gfortran -E libffi -E openssl -E pkgconfig -E freetype.dev -E libjpeg.dev -s numpy -s flit -s intreehooks -s cython -e pytest-runner -e setuptools-scm -r requirements.txt -r requirements-dev.txt
#
