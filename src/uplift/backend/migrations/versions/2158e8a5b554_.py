...
def upgrade():
    ...
    with op.batch_alter_table('shipit_dashboard_analysis_bugs') as batch_op:
        batch_op.create_unique_constraint('shipit_dashboard_uniq_ba', 'shipit_dashboard_analysis_bugs', ['analysis_id', 'bug_id'])
