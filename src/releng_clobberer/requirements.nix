...
#
# COMMAND:
#   pypi2nix -v -V 3.5 -E postgresql libffi openssl -r ../../lib/releng_common/requirements-dev.txt -r requirements.txt -r requirements-dev.txt -r requirements-nix.txt
#
