...
let
  ...
  generated = self: {
    ...
    "json-e" = python.mkDerivation {
      name = "json-e-2.6.0";
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/04/6a/6cce4b49030990ef410c5f7e6afbeafd3341766b119eb3bc6708f4a36d04/json-e-2.6.0.tar.gz"; sha256 = "fcdb79e0da91466260af9a5a67a25916f02eac66e8f02e8dc3161182bd11c1bc"; };
      doCheck = commonDoCheck;
      checkPhase = "";
      installCheckPhase = "";
      buildInputs = commonBuildInputs;
