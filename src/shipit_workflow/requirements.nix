...
let
  ...
  generated = self: {
    ...
    "json-e" = python.mkDerivation {
      name = "json-e-2.5.0";
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/4f/8f/13ffbae3327362410719cd6ae89296281e68e3102e1ac042c47795e10bc2/json-e-2.5.0.tar.gz"; sha256 = "f9114a25ed4b575395fbb2daa1183c5b781a647b387fdf28596220bb114673e8"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [ ];
      meta = with pkgs.stdenv.lib; {
