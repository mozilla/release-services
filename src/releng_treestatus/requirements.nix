...
let
  ...
  generated = self: {
    ...
    "flask-talisman" = python.mkDerivation {
      name = "flask-talisman-0.3.0";
      src = pkgs.fetchurl { url = "https://pypi.python.org/packages/b6/9e/3a5fe1e846e6ec9d000dd15bf1a2a0972ee61c48d70f24e532fb219c856c/flask-talisman-0.3.0.tar.gz"; sha256 = "bb25143b46c31a36786225d6752e8f5c9fbfc5a7c25e99d1b06e04d5b268c815"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."six"
