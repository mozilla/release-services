...
def app():
    ...
    from shipit_uplift.flask_control import app
...
def header_user(app):
    ...
    """
    from shipit_uplift.flask_control import SCOPES_USER
...
def header_admin(app):
    ...
    """
    from shipit_uplift.flask_control import SCOPES_ADMIN
...
def header_bot(app):
    ...
    """
    from shipit_uplift.flask_control import SCOPES_BOT
