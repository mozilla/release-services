...
let
  ...
  generated = self: {
    ...
    "google-api-python-client" = python.mkDerivation {
      name = "google-api-python-client-1.7.0";
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/7c/a9/8cac353a80ee4aaefdaee034e78ee9ec73e2b95831ae7f640c2016ed6977/google-api-python-client-1.7.0.tar.gz"; sha256 = "5dcd2b3f2dcdf69d6bcf0c215ca8730fa6363ed0177ba2083e2e6f614e7682e9"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."google-auth"
    ...
    "icalendar" = python.mkDerivation {
      ...
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/aa/58/d9fb6d9dc8919e32c175a56a25a296c7ca9d5f4075e52647126d40dcf6c6/icalendar-4.0.1.tar.gz"; sha256 = "682a42023d3d43a3a83933b4e329d109aabb07c9e11cb94a4d83ca687c3a3e8d"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."python-dateutil"
    ...
    "libmozdata" = python.mkDerivation {
      ...
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/7f/ef/68e912a1da0c81444c21c747cf7ef552c4e4fe3ef2823df0aeff7d04531a/libmozdata-0.1.39.tar.gz"; sha256 = "357a96058dc985e3d9b0fe4cbb98a60bfb2b60af6458e8a2f07e7d360ae02437"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."elasticsearch"
