...
#
# COMMAND:
#   pypi2nix -v -C /home/rok/dev/mozilla/services/src/tooltool/api/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -E postgresql -e vcversioner -e pytest-runner -e setuptools-scm -r requirements.txt -r requirements-dev.txt
#
